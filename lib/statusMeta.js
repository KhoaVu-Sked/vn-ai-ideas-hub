...
// Two singular roles, one of each per idea (partial unique indexes enforce it):
//   INITIATOR_ROLE — who raised the idea. A fact, set at submission.
//   LEAD_ROLE      — who is accountable for driving it. Transferable by an admin.
...
// Initiator is not self-assignable — you cannot claim to have raised someone
// else's idea. Only an admin can correct it.
