...
// right back where it was (/learning/journey, the default below), while
...
export const DEFAULT_CALENDAR_RETURN = "/learning/journey";
const CALENDAR_RETURN_PATHS = new Set([DEFAULT_CALENDAR_RETURN, "/learning"]);
