...
// Deliberately empty — no knowledge-artifact data exists anywhere in this
// schema (NotebookLM generation isn't built), so nothing is faked here.
function KnowledgeArtifactsCard() {
  return (
    <section style={card}>
      <h2 style={{ fontFamily: "var(--font-sora)", fontWeight: 700, fontSize: 15, color: "var(--ink)", margin: "0 0 2px" }}>Knowledge artifacts</h2>
      <p style={{ fontSize: 12, color: "var(--muted)", margin: 0 }}>Generated by NotebookLM on completion</p>
    </section>
  );
}
