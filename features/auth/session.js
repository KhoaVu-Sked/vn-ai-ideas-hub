...
export const SESSION_MAX_AGE = 30 * 60; // 30 minutes (seconds); slides on activity
...
// payload: { uid, username, name, role, sid }
// sid is the account's current session_id — see requireUser() in lib/guard.
