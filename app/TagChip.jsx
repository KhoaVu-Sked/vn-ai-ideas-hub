...
export default function TagChip({ name, catalog }) {
  return (
    <span style={{ display: "inline-flex", alignItems: "center", gap: 6, background: "var(--bg)", color: "var(--body)", border: "1px solid var(--line)", fontSize: 11, fontWeight: 600, padding: "3px 9px", borderRadius: 6, whiteSpace: "nowrap" }}>
